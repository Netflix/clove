...
def create_model_and_preprocessing(
        model_name: str,
        *args,
        context_length: int | None = None,
        **kwargs,
) -> tuple[ImageTextModel, Transform, Transform, HFTokenizer]:
    tokenizer = get_tokenizer(model_name, context_length=context_length)
    return (*create_model_and_transforms(model_name, *args, tokenizer=tokenizer, **kwargs), tokenizer)  # noqa
