...
parser.add_argument("--results-file", default="", metavar="FILENAME", help="Output csv file for results")
parser.add_argument("--profiler", default="torch", choices=["torch", "fvcore"])
...
def main():
    ...
    df = df.sort_values(["gmacs" if "gmacs" in df.columns else "gflops", "mparams", "model"])
