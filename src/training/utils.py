...
def get_state_dict(checkpoint: Mapping[str, Any] | torch.jit.ScriptModule, model: ImageTextModel | None = None,
...
def patch_model(model: ImageTextModel, state_dict, weight_for_state_dict: float = 0.5) -> None:
